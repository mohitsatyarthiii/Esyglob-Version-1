...
export const DEFAULT_LOGISTICS_RULES = [
  {
    ...
    mode: 'standard',
    incoterm: 'CIF',
    eta: '18-35 business days',
    baseCharge: 6500,
    variableRate: 0.012,
    providerKey: 'manual',
    internalBreakdown: { freight: 4200, insurance: 700, handling: 500, documentation: 400, fuel: 300, portCharges: 400 },
  },
  {
    key: 'esyglob_premium',
    ...
    variableRate: 0.018,
    providerKey: 'manual',
    internalBreakdown: { freight: 8600, insurance: 900, handling: 900, documentation: 500, fuel: 900, serviceCharges: 700 },
  },
  {
    key: 'esyglob_express',
    ...
    variableRate: 0.025,
    providerKey: 'manual',
    internalBreakdown: { freight: 13000, insurance: 1200, handling: 900, packaging: 600, documentation: 500, fuel: 1400, serviceCharges: 900 },
  },
];
