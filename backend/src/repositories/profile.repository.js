  ...
  static buildProfileResponse(user, seller) {
    return {
      profile: {
        ...
        expectedOrderQuantity: user.metadata?.expectedOrderQuantity || '',
        sourcingCountries: user.metadata?.sourcingCountries || [],
        paymentMethods: user.metadata?.paymentMethods || [],
        shippingMethods: user.metadata?.shippingMethods || [],
