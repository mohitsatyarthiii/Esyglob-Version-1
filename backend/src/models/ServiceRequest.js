...
const serviceRequestSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ['draft', 'submitted', 'under_review', 'documents_required', 'booking_pending', 'confirmed', 'pickup_scheduled', 'picked_up', 'in_transit', 'out_for_delivery', 'completed', 'cancelled', 'failed'],
      default: 'submitted',
      index: true,
    },
    priority: {
    ...
    providerQuoteId: { type: mongoose.Schema.Types.ObjectId, ref: 'ServiceProviderQuote' },
