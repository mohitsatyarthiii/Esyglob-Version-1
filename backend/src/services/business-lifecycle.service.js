...
export const LIFECYCLE_DEFINITIONS = Object.freeze({
  rfq: freezeTransitions({
    draft: { buyer: { submit: 'active', cancel: 'cancelled' } },
    ...
    information_requested: { buyer: { resubmit: 'active', cancel: 'cancelled' }, seller: {} },
    rejected: { buyer: { revise: 'draft', reopen: 'active' }, seller: {} },
  ...
  quotation: freezeTransitions({
    ...
    buyer_accepted: { seller: { confirm: 'agreement_pending', request_revision: 'revision_requested', reject: 'rejected' }, buyer: { reopen: 'submitted' } },
    agreement_pending: { seller: { sign: 'agreement_pending' }, buyer: { sign: 'agreement_signed' } },
    agreement_signed: { buyer: { start_order: 'won' } },
    rejected: { buyer: { reopen: 'submitted' } },
    withdrawn: { seller: { reopen: 'draft' } },
    won: {}, lost: {}, expired: {}, accepted: { seller: { confirm: 'agreement_pending' } },
  }),
  ...
  order: freezeTransitions({
    ...
    pickup_scheduled: { logistics_provider: { pickup: 'picked_up' } },
    picked_up: { logistics_provider: { transit: 'in_transit', warehouse: 'warehouse_processing' } },
    ...
    in_transit: { logistics_provider: { delivery: 'out_for_delivery', delivered: 'delivered', return: 'returned' } },
    shipped: { logistics_provider: { transit: 'in_transit', delivered: 'delivered' }, buyer: { dispute: 'disputed' } },
    out_for_delivery: { logistics_provider: { delivered: 'delivered', return: 'returned' } },
