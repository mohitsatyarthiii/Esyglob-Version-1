...
class OrderService {
  ...
  static async startOrder(userId, body) {
    ...
    if (quotation.status !== 'agreement_signed' || quotation.agreement?.status !== 'completed') throw Object.assign(new Error('Order creation is locked until buyer acceptance, seller confirmation, and both agreement signatures'), { statusCode:409 });
