...
export async function previewDocument(req, res) {
  try {
    ...
    const signatureRoles = [
      ...(document.requiresSellerSignature ? ['seller'] : []),
