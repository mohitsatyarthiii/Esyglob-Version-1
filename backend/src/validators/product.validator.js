...
export const productSchema = z.object({
  ...
  discount: z.object({
    ...
    status: z.enum(['inactive', 'active', 'scheduled']).optional().default('inactive'),
  ...
  priceTiers: z.array(z.object({
    minimumQuantity: z.coerce.number().min(1).optional().nullable(),
  ...
  })).max(3, 'A maximum of three pricing tiers is allowed').optional().default([]),
  images: z.array(z.string().trim().min(1)).optional().default([]),
