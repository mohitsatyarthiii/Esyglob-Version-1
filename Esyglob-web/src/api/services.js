...
export const SERVICE_CATALOG = [
  ...
  service('supplier-verification', 'Supplier Verification', 'Verification', 'buyer', 'Verify supplier credentials, registration records and business documents.', 'Quote based', ['Supplier details', 'Verification scope', 'Review report'], [...contactFields(), field('supplierName', 'Supplier name', 'text', true), field('details', 'What should be verified?', 'textarea', true)]),
  ...
  service('documentation-support', 'Documentation Support', 'Advisory', 'both', 'Get help with invoices, packing lists, certificates and shipping paperwork.', 'From INR 799', ['Document checklist', 'Preparation support', 'Completion review'], [...contactFields(), field('orderReference', 'Order or shipment reference'), field('details', 'Document support needed', 'textarea', true)]),
]
