...
export const SERVICE_CATALOG = [
  service('shipping', 'Shipping & Logistics', 'Logistics', 'both', 'Compare live, serviceable courier rates and book directly with an available provider.', 'Live provider rates', ['Pickup information', 'Destination information', 'Shipment details'], [
    ...
    field('shipmentDescription', 'Contents description', 'text', true, undefined, 'Shipment details'), field('quantity', 'Package quantity', 'number', true, undefined, 'Shipment details'), field('weightKg', 'Total weight (kg)', 'number', true, undefined, 'Shipment details'), field('lengthCm', 'Length (cm)', 'number', true, undefined, 'Shipment details'), field('widthCm', 'Width (cm)', 'number', true, undefined, 'Shipment details'), field('heightCm', 'Height (cm)', 'number', true, undefined, 'Shipment details'), field('declaredValue', 'Declared value', 'number', true, undefined, 'Shipment details'), field('currency', 'Currency', 'select', true, ['INR', 'USD', 'EUR', 'GBP'], 'Shipment details'), field('contents', 'Contents type', 'select', true, ['non_documents', 'documents'], 'Shipment details'),
