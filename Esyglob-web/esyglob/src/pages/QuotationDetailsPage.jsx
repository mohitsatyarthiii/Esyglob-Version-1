...
export default function QuotationDetailsPage() {
  ...
  async function buyerAction(action) {
    ...
    try {
      ...
      setDialog(''); setActionText(''); setCounterPrice(''); setMessage(action === 'accept' ? 'Quotation accepted. The Seller will now prepare the Final Quotation.' : 'Your response was sent to the supplier.'); await query.reload()
  ...
  const canAccept = openStatuses.includes(item.status) && Boolean(resolveId(item.productId))
